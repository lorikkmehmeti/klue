   ...
   return (
      <div>
         ...
         <div className="max-w-7xl mx-auto lg:pt-[5rem] sm:px-3 lg:px-0">
            ...
            >
               <li className="relative flex flex-col items-start p-6 hover:bg-zinc-800/5 rounded-md">
                  <Link to="/daily">
                     ...
                     <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400 pointer-events-none">
                        Test your plot knowledge daily! Decode anime from
                        keywords. New challenge, new story, every day.
                     </p>
                  </Link>
               </li>
               <li className="relative flex flex-col items-start p-6 hover:bg-zinc-800/5 rounded-md">
                  <Link to="/unlimited">
                     ...
                     <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400 pointer-events-none">
                        Endless plot puzzles await! Movies/anime revealed by
                        keywords. Dive into limitless entertainment and guess
                        them all.
                     </p>
                  </Link>
               </li>
               <li className="relative flex flex-col items-start p-6 hover:bg-zinc-800/5 rounded-md pointer-events-none disabled:opacity-30">
                  <Link
                     to="/"
                  ...
                  >
                     ...
                     <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400 pointer-events-none">
                        Compete head-to-head! Who decodes anime names faster?
                        Battle wits in this thrilling challenge!
                     </p>
                  </Link>
               </li>
               <li className="relative flex flex-col items-start p-6 hover:bg-zinc-800/5 rounded-md pointer-events-none disabled:opacity-30">
                  ...
                  >
                     ...
                     <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400 pointer-events-none">
                        Unlock the mystery! Select an anime pack, guess the
                        titles within. Will you conquer the randomness and name
                        them all?
                     </p>
                  </Link>
               </li>
