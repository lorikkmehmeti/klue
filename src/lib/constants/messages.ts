...
export const wm: { title: string; description: string }[] = [
   ...
   },
   {
      ...
      description:
         "It happens to the best of us! Your answer isn't quite right, but you're making progress.",
   },
   {
   ...
   },
   {
      title: 'Try again',
      description:
         "It looks like your answer wasn't quite right. Give it another shot!",
   },
   {
